#!/bin/bash
# runSimulation.sh - Run single bursting bubble simulation from root directory
...
Run single bursting bubble simulation from root directory.
...
if [ $STAGE -eq 1 ] || [ $STAGE -eq 0 ]; then
    ...
    # Execution - Run briefly to generate restart file
    echo ""
    ...
    if [ $STAGE -eq 1 ]; then
        ...
        echo "  $0 --stage2 --mpi 8 $PARAM_FILE"
    fi
    echo "========================================="
fi
